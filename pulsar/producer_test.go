...
func (m *mockConn) bufferCount() int {
	m.l.Lock()
	defer m.l.Unlock()
	return len(m.buffers)
}

func (m *mockConn) buffer(index int) internal.Buffer {
	m.l.Lock()
	defer m.l.Unlock()
