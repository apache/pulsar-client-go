...
const (
	// FailSend this is the default option to fail send if crypto operation fails.
	FailSend ProducerCryptoFailureAction = iota
...
const (
	// FailConsume this is the default option to fail consume messages until crypto succeeds.
	FailConsume ConsumerCryptoFailureAction = iota
